...
import com.bccv.boxcomic.sns.SNSShareManager.ShareStateListener;
import com.bccv.boxcomic.sns.ShareConstants;
import com.bccv.boxcomic.sns.bean.SNSUserInfo;
import com.bccv.boxcomic.sns.util.SNSTokenKeeper;
...
public class SinaShare {
    ...
    public void share2sina(final Activity context,final String content,final String imageUrl,final Bitmap bitmap,final ShareStateListener mShareStateListener){
    	...
    	if(mShareStateListener==null){
    		...
    		mShareStateListener.shareAction(ShareStateListener.SHARING, " sina sharing ! ");
    	}
    ...
    private void ready2share(Context context,String content, String imageUrl, Bitmap bitmap,ShareStateListener mShareStateListener){
    	...
    	Logger.v(TAG+"ready2share", " -- ready2share start !!! --" );
    	SinaShareRequestListener sinaShareRequestListener = new SinaShareRequestListener(mShareStateListener);
    	
    	Logger.v(TAG+"ready2share", "content : " + content + " imageUrl : " + imageUrl + " bitmap == null : " + String.valueOf(bitmap == null) );
            ...
            mSsoHandler.authorize(new WeiboAuthListener(){
                ...
                public void onComplete(Bundle bundle) {
                    ...
                    if (accessToken != null && accessToken.isSessionValid()) {
                        ...
                        Logger.e(TAG+"authSinaWeibo",  "fromShare : " + fromShare +" bundle : " + bundle.toString());
                        
                        System.out.println("@@@@@@@@@@@@@@@1111" + fromShare);
                        if(fromShare){
                        ...
                        if(mAuthorizingStateListener!=null) 
                        	mAuthorizingStateListener.authrizeAction(AuthorizingStateListener.AUTHORIZE_SUCCESS, " sina auth success , waiting get userinfo ");
                        ...
                        mUsersAPI.show(Long.valueOf(accessToken.getUid()), mListener);
    ...
    private class SinaShareRequestListener implements RequestListener{
		...
		@Override
		public void onComplete(String response) {
			Logger.v(TAG+"SinaShareRequestListener onComplete", response);
			if(mShareStateListener!=null){
				mShareStateListener.shareAction(ShareStateListener.SHARE_SUCCESS, " sina share success ");
			}
		}
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		Logger.e(TAG+"onActivityResult", requestCode+"");
        if (mSsoHandler != null) {
