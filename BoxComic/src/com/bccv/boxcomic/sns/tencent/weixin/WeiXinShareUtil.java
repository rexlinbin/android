package com.bccv.boxcomic.sns.tencent.weixin;
...
import com.bccv.boxcomic.wxapi.WXEntryActivity;
...
public class WeiXinShareUtil{
	...
	public static final String APP_ID = "wx2ccba9c5f1de05a2";
	public static final String APP_SECRET = "683fba957e883ffc7ceb6932a01d0359";
	...
	public void shareMessage(final ShareInfo shareInfo,
		...
		Logger.v(TAG, "shareMessage start --- ");
		
		Logger.v(TAG, "shareMessage  shareInfo : >> " + shareInfo.toString());
		...
		if(!wxApi.isWXAppInstalled()){
			...
			Logger.v(TAG, "shareMessage  wxApi.isWXAppInstalled() : >> " + wxApi.isWXAppInstalled());
			//TODO 
...
//						bmp = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.default_weixin160);
					...
					if(bmp!=null){
						...
						Logger.v(TAG+"shareMessage","bmp is null");
					}
					
					req.message = msg;
					
					if(shareInfo.SNSType == SNSShareManager.TENCENT_WEIXIN_TYPE){
						Logger.v(TAG+"shareMessage","SNSType : TENCENT_WEIXIN_TYPE");
						req.scene = SendMessageToWX.Req.WXSceneSession;	
					}else{
						Logger.v(TAG+"shareMessage","SNSType : TENCENT_WEIXIN_FRIEND_TYPE");
	...
	public void login(AuthorizingStateListener authorizingStateListener){
		...
		if(!wxApi.isWXAppInstalled()||!wxApi.isWXAppSupportAPI()){
			...
			Log.v(TAG, "shareMessage  wxApi.isWXAppInstalled() : >> " + wxApi.isWXAppInstalled());
			Toast.makeText(mContext, "微信版本过低或未安装微信客户端", Toast.LENGTH_SHORT).show();
			//TODO 
//			new WeixinDownloadDialog(mContext, ActivityQueue.popIndex(0));
