...
import com.bccv.boxcomic.ebook.EbookActivity.ScrollOverCallback;
...
public class EbookView extends View {
	...
	private ScrollOverCallback scrollOverCallback = null;
	...
	protected void onDraw(Canvas canvas) {
		// if (mTouch.x > mWidth * 9 / 5 || mTouch.x < - mWidth * 4 / 5) {
	...
	public void setScrollOverCallback(ScrollOverCallback scrollOverCallback) {
		this.scrollOverCallback = scrollOverCallback;
	}
