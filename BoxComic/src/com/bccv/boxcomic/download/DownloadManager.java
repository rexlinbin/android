...
public class DownloadManager {
    ...
    public void addNewDownload(String url, String fileName, String target,
                               ...
                               final RequestCallBack<File> callback, String app_idString, String app_urlString, String app_titleString, String chapter_id, String chapter_name, String chapter_size ,String pageNum) throws DbException {
        ...
        downloadInfo.setApp_titleString(app_titleString);
        downloadInfo.setChapter_id(chapter_id);
        downloadInfo.setChapter_name(chapter_name);
        downloadInfo.setChapter_size(chapter_size);
        downloadInfo.setPageNum(pageNum);
