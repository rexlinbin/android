package com.bccv.bangyangapp.network;
...
public class HttpService {
	...
	private int mThreadNum = 5; // 自大运行线程数量
	...
	public void cancelReq(HttpReq req) {
		if (req.getServiceTag() == TAG_RUNNING) {
			for (Iterator<HttpReq> it = mRunningReqList.iterator(); it
					.hasNext();) {
	...
	public void onReqFinish(HttpReq req) {
		...
		if (successDelete == false) {
			L.e(TAG, "onReqFinish", "successDelete : " + successDelete);
		}
