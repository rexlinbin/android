		...
		if (success) {
			try {
				...
				for (int i = 0; i < jsonArray.length(); i++) {
					...
					commentItemBean.setQuestions(dataObject.optString("questions"));
					commentItemBean.setAnswer(dataObject.optString("answer"));
					commentItemBean.setUser_icon(dataObject.optString("user_icon"));
					commentItemBean.setUser_id(dataObject.optString("user_id"));
					commentItemBean.setUser_name(dataObject.optString("user_name"));
