...
public class SystemUtil {
	...
	public static final String UNZIP_GAME = "game";
	...
	public static final int UNZIP_TYPE = 4;
	 ...
	 * @return
	 */
	public static String getCacheFolder(int type) {
		String status = Environment.getExternalStorageState();
	...
	public static ArrayList<InstallAppInfo> getInstallAppInfos(Context context) {
		...
		for (PackageInfo installedPackage : installedPackages) {
			if ((installedPackage.applicationInfo.flags & ApplicationInfo.FLAG_SYSTEM) == 0) {
				...
				installAppInfo.setAppName(installedPackage.applicationInfo.loadLabel(packageManager).toString());
				...
				installAppInfo.setDrawable(installedPackage.applicationInfo.loadIcon(packageManager));
	 ...
	 * @return
	 */
	public static Drawable getCurAppIcon(Context context,String app_package) {

		try {
			PackageManager packageManager = context.getPackageManager();
			PackageInfo info = packageManager.getPackageInfo(app_package, 0);
