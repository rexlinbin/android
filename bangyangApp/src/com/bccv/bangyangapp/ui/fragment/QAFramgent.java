...
import com.bccv.bangyangapp.ui.activity.LoginActivity;
import com.bccv.bangyangapp.ui.activity.MainActivity;
import com.bccv.bangyangapp.ui.activity.PersonalZoneActivity;
import com.bccv.bangyangapp.ui.activity.ReportMsgActivity;
import com.bccv.bangyangapp.ui.adapter.QAListAdapter;
import com.bccv.bangyangapp.ui.adapter.QAListAdapter.OnBtnClickListener;
...
public class QAFramgent extends PrimaryFramgent implements IXListViewListener,
	...
	private void requestData(int p) {
		if (SystemUtil.isNetOkWithToast(mActivity)) {
			...
			NetWorkAPI.app_question(mActivity.getApplicationContext(), p,
					new HttpCallback() {
		...
		case R.id.qa_send_btn:
			...
			if (SystemUtil.isNetOkWithToast(mActivity)) {
				...
				if(UserInfoManager.isLogin()){
					...
					NetWorkAPI.answer(mActivity, answer, questionInfoBean.getId(),
							new HttpCallback() {
