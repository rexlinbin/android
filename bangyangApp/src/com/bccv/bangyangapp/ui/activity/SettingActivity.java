...
import com.bccv.bangyangapp.utils.FileUtils;
	...
	public void onClick(View v) {
		...
		case R.id.rl_friends:
			if (!shareWindow.isShowing()) {
				...
				info.title = "榜样";
				info.text = "同学~推荐一个好玩的应用给你,里面介绍的应用不错，看看吧~o(∩_∩)o ";
				info.url = "http://appsapi.bccv.com/res/bangyangApp.apk";
...
//				info.imagePath = "file:///android_asset/ic_launcher.png" ; 
	...
	private void getCacheSize() {
		cacheDir = com.bccv.bangyangapp.utils.ImageLoaderUtil
...
//			version_desS = data.getApp_des();
			if (versionCode > 0 && new_version > 0) {
				if (versionCode < new_version) {
					...
					tv.setText("榜样提示: 新版本: "+version_name);
