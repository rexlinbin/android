...
public class HotFreshChildListAdapter extends BaseAdapter {

	private Context mContext;
	private ArrayList<AppInfoItemBean> data;
	private OnBtnClickListener onBtnClickListener;

	public HotFreshChildListAdapter(Context context,
			ArrayList<AppInfoItemBean> data,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Holder holder;
		if (convertView == null) {
			convertView = View.inflate(mContext, R.layout.common_app_list_item,
					null);
			holder = new Holder();

			holder.handpick = (ImageView) convertView
					.findViewById(R.id.common_app_item_handpick);
			holder.usericon = (ImageView) convertView
					.findViewById(R.id.common_app_item_usericon);
			holder.username = (TextView) convertView
					.findViewById(R.id.common_app_item_username);
			holder.time = (TextView) convertView
					.findViewById(R.id.common_app_item_time);
			holder.app_poster = (ImageView) convertView
					.findViewById(R.id.common_app_item_app_poster);
			holder.app_icon = (ImageView) convertView
					.findViewById(R.id.common_app_item_app_icon);
			holder.appname = (TextView) convertView
					.findViewById(R.id.common_app_item_appname);
			holder.appintro = (TextView) convertView
					.findViewById(R.id.common_app_item_appintro);
			holder.appcolumn = (TextView) convertView
					.findViewById(R.id.common_app_item_appcolumn);
			holder.appcharge = (TextView) convertView
					.findViewById(R.id.common_app_item_appcharge);
			holder.app_introduce = (TextView) convertView
					.findViewById(R.id.common_app_item_app_introduce);
			holder.sharetype_tv = (TextView) convertView
					.findViewById(R.id.sharetype_tv);
			holder.carecount_tv = (TextView) convertView
					.findViewById(R.id.carecount_tv);
			holder.commentcount_tv = (TextView) convertView
