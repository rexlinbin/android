...
public class MyAppCommentChildListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageLoaderUtil.getInstance(mContext).displayImage(myCommentItemBean.getIcon(), holder.icon, ImageLoaderUtil.getAppIconImageOptions());
		...
		holder.icon.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(onBtnClickListener!=null){
					onBtnClickListener.onAppIconClick(myCommentItemBean.getApp_id());
				}
