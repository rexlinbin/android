...
public class HomeListAdapter extends BaseAdapter {
	...
	public HomeListAdapter(Context context,List<Special> dataList){
...
//		holder.special_pic.setImageHeight(height.get(position));
		...
		Special special = dataList.get(position);
		holder.special_pic.setImageWidth(special.getSpecial_pic_w());
		holder.special_pic.setImageHeight(special.getSpecial_pic_h());
		
		//TODO 设置图片
		ImageLoaderUtil.getInstance(mContext).displayImageWithNone(special.getSpecial_pic(), holder.special_pic);
		...
		holder.likeNum.setText(String.valueOf(special.getZan_num()));
