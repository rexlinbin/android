...
public class LocationActivity extends MapActivity implements Stackable,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        push();
        setContentView(R.layout.rc_activity_poi_search);
    ...
    protected void onDestroy() {
        ...
        if (RCUtil.getLocationCallback() != null){
        	RCUtil.getLocationCallback().onFailure("失败");
        }
        RCUtil.setLocationCallBack(null);
        TencentLocationManager.getInstance(this).removeUpdates(this);
    ...
    public void onClick(View v) {
        ...
        if (mMsg != null) {
        	if (RCUtil.getLocationCallback() == null) {
				Logger.e(TAG, "onClick","location callback is null");
			}else{
				RCUtil.getLocationCallback().onSuccess(mMsg);
				RCUtil.setLocationCallBack(null);
				finish();
			}
        } else {
            RCUtil.getLocationCallback().onFailure("定位失败");
        }
