 ...
 * @date 2014-12-8
 */
public class DataBaseConfig implements IMeituDataBase {
	 ...
	 */
	public static final int DATABASE_CURRENT_VERSION = DataBaseConfig.MEITU_DATABASE_VERSION_1_0;
	
	/**
	 * 数据库版本(1.0)
	 */
	public static final int MEITU_DATABASE_VERSION_1_0 = 1;
