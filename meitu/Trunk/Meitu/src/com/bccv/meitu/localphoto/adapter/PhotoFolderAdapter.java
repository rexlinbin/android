package com.bccv.meitu.localphoto.adapter;
...
import com.bccv.meitu.localphoto.bean.AlbumInfo;
import com.bccv.meitu.localphoto.imageaware.RotateImageViewAware;
import com.bccv.meitu.localphoto.util.ThumbnailsUtil;
...
public class PhotoFolderAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		UniversalImageLoadTool.disPlay(ThumbnailsUtil.MapgetHashValue(albumInfo.getImage_id(),albumInfo.getPath_file()), 
				new RotateImageViewAware(viewHolder.image,albumInfo.getPath_absolute()), R.drawable.common_defalt_bg);
