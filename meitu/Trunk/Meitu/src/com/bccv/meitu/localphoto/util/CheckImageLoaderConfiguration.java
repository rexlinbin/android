package com.bccv.meitu.localphoto.util;
	...
	public static void checkImageLoaderConfiguration(Context context){
		if(!UniversalImageLoadTool.checkImageLoader()){
			...
			ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(context)
					...
					.discCache(new LimitedAgeDiscCache(StorageUtils.getCacheDirectory(context),null,new Md5FileNameGenerator(), discCacheLimitTime))
