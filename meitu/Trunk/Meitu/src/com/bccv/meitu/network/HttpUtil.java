...
public class HttpUtil {
	...
	private final static int SO_TIMEOUT = 10000;// 连接超时时间
	...
	private static HttpGet getHttpGet(String url) {
		...
		httpget.setHeader("User-Agent", "(C)NokiaE5-00/SymbianOS/9.1 Series60/3.0 BCCV/yuese");
	...
	private static HttpPost getHttpPost(String url) {
		...
		httpPost.setHeader("User-Agent", "(C)NokiaE5-00/SymbianOS/9.1 Series60/3.0 BCCV/yuese");
	 ...
	 * @return
	 */
	public static String http_get(Context context,String url, Map<String, Object> params) { 
...
//				responseBody = IS2byteArray(is);
				...
				Logger.e(Logger.TAG, TAG, e.getMessage());
				return null;
			} finally {
				if (null != httpClient){
...
//			return null;
	 ...
	 * @return
	 */
	public static String http_post(Context context,String url, Map<String, Object> params,Map<String,File> files){
		
		HttpClient httpClient = null;
		HttpPost httpPost = null;
//		byte[] responseBody = null;
		String responseStr = null;
		Logger.v(TAG, "http_post","url : " + url);
		InputStream is = null;
		int time = 0;
		do{
			try{
				...
				httpPost = getHttpPost(url);
				 if(params!=null&&params.size()>0){
					 ...
					 for (Entry<String, Object> entry : entrySet) {
						 ...
						 Logger.v(TAG, "http_post", entry.getKey()+"="+entry.getValue().toString());
