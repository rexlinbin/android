...
//	    FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(mZoomWidth, mScreenHeight/2);
	    FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(mZoomWidth, ScreenUtil.dp2px(getContext(), 305));
...
//        localLayoutParams.height = mScreenHeight/2;
        localLayoutParams.height = ScreenUtil.dp2px(getContext(), 305);
...
//         mHeaderContainer.setOnTouchListener(new OnTouchListener() {
// 			
// 			@Override
// 			public boolean onTouch(View arg0, MotionEvent arg1) {
// 				
// 				Log.d(TAG, "onTouch --> mHeaderContainer  action = " + (0xFF & arg1.getAction()));
// 				onTouchEvent(arg1);
// 				return false;
// 			}
// 		});
//         mZoomContainer.setOnTouchListener(new OnTouchListener() {
//  			
//  			@Override
//  			public boolean onTouch(View arg0, MotionEvent arg1) {
//  				
//  				Log.d(TAG, "onTouch --> mZoomContainer action = " + (0xFF & arg1.getAction()));
//  				onTouchEvent(arg1);
//  				return false;
//  			}
//  		});
//        mRootContainer.setOnTouchListener(new OnTouchListener() {
// 			
// 			@Override
// 			public boolean onTouch(View arg0, MotionEvent arg1) {
// 				
// 				Log.d(TAG, "onTouch --> mRootContainer action = " + (0xFF & arg1.getAction()));
// 				onTouchEvent(arg1);
// 				return false;
// 			}
// 		});
            ...
            switch (0xFF & ev.getAction()) {
                ...
                case MotionEvent.ACTION_POINTER_DOWN:
                	try {
						...
						Logger.e(TAG, "touch event", e.getMessage());
					}
                    break;
            }
        }
