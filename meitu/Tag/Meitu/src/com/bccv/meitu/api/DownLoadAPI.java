...
import com.bccv.meitu.download.DownloadManager;
import com.bccv.meitu.download.DownloadService;
...
public class DownLoadAPI {
	...
	public static void downLoadApk(String url, String name, String packageName,
		...
		Logger.v(TAG, "downLoadApk","url : " + url + " name : " + name + " packageName : " 
		...
		if(!isServiceStarted(mContext)){
			...
			timer.schedule(new TimerTask() {
				@Override
				public void run() {
					Logger.v(TAG, "download", " send download broadcast !!! ");
	...
	public static void downLoadFile(String url, String name, boolean showProgress){
		...
		Logger.v(TAG, "downLoadFile","url : " + url + " name : " + name );
	...
	public static boolean isServiceStarted(Context context) {
		...
		Logger.v(TAG, "isStarted", "Check Download Service");
		...
		Logger.v(TAG, "isStarted NotificationService is running ", String.valueOf(isRunning));
		return isRunning;
	}
	
	public static void startDownLoadService(Context context){
		Logger.v(TAG, "startDownLoadService", "---start----");
	...
	public static void stopDownLoadService(Context context) {
		Logger.v(TAG, "stopDownLoadService", "---stop----");
		Intent downLoadService = new Intent();
		downLoadService.setClass(context, DownloadService.class);
