package com.bccv.meitu.sns.sina;
...
public class SinaShare {
            ...
            mSsoHandler.authorize(new WeiboAuthListener(){
                ...
                public void onComplete(Bundle bundle) {
                    ...
                    if (accessToken != null && accessToken.isSessionValid()) {
                        ...
                        Logger.v(TAG, "authSinaWeibo",  "fromShare : " + fromShare +" bundle : " + bundle.toString());
    ...
    private class SinaAuthRequestListener implements RequestListener{
		...
		public void onComplete(String response) {
			Logger.v(TAG, "SinaRequestListener onComplete", response+"");
