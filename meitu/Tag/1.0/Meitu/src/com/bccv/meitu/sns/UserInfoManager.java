...
//	private static String HEADPIC_CHANGE_TAG = "headpic_change_tag";
	...
	public synchronized static void saveUserInfo(UserInfo userInfo){
		if(userInfo!=null){
			...
			edit.putInt(USER_MONEY, userInfo.getUser_money());
...
//	
//	public static void setHeadPicChangeTag(boolean tag){
//		Editor edit = sp.edit();
//		edit.putBoolean(HEADPIC_CHANGE_TAG, tag);
//		edit.commit();
//	}
//	
//	public static void isHeadPicChanged(){
//		Editor edit = sp.edit();
//		edit.putBoolean(HEADPIC_CHANGE_TAG, false);
//		edit.commit();
//	}
//	
	/**
