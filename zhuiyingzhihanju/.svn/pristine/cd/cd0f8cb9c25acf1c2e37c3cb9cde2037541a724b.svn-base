...
import com.utils.pulltorefresh.PullToRefreshScrollView;
...
//
//			list = (GridView) view.findViewById(R.id.special_listView);
//			
//			adapter = new SpecialAdapter(data, getActivity());
//			scroll=(PullToRefreshScrollView) view.findViewById(R.id.scrollView1);
...
//			
//
//			scroll.setOnRefreshListener(new OnRefreshListener<ScrollView>() {
//
//				@Override
...
//
//						scroll.onPullDownRefreshComplete();
//					} else {
//						getData(true);
//
//					}
...
//					// TODO Auto-generated method stub
//					if (NetUtil.isNetworkAvailable(GlobalParams.context)) {
//						((FooterLoadingLayout) scroll.getFooterLoadingLayout())
//								.getmHintView().setText("数据加载中...");
//						getData(false);
//					} else {
//						PromptManager.showToast(GlobalParams.context, "网络不给力");
//						scroll.onPullUpRefreshComplete();
//					}
//				}
//				
//			});
