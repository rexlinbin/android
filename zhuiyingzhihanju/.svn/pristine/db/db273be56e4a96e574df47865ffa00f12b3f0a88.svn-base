...
public class PlayerHDAdapter extends BaseAdapter {
	Context context;
	List<HD> list;

	public PlayerHDAdapter(Context context, List<HD> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(context, R.layout.listitem_player, null);
