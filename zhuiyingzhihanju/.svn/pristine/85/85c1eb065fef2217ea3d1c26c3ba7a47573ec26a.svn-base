...
//		GlobalParams.activity = this;
	...
	public void startActivityWithResultSlideAnimation(Class<?> pClass) {
		startActivityForResultSlideAnimation(pClass, null);
	}
	
	
	
	protected void startActivityForResultSlideAnimation(Class<?> pClass,
			Bundle pBundle) {
		Intent intent = new Intent(this, pClass);
		if (pBundle != null) {
			intent.putExtras(pBundle);
