...
//        String newQueryUrl = queryUrl.replaceAll("%3D", "=").replaceAll("%3F", "?").replaceAll("%26", "&");
        String newQueryUrl = URLDecoder.decode(queryUrl, params.getCharset());
        URL url = new URL(newQueryUrl);
        { // init connection
