...
import com.utils.updatedownload.Version;
...
public class PromptManager {
	...
	public static void showProgressDialog(Context context) {
		// LinearLayout view = (LinearLayout) View.inflate(context,
	...
	public static void showCancelProgressDialog(Context context, final DataAsyncTask dataAsyncTask) {
		...
		cancelAlertDialog = new AlertDialog.Builder(context).create();
		// dialog.setView(view, 0, 0, 0, 0);
	...
	@SuppressLint("NewApi")
	public static void showCancelProgressDialog(Context context) {
		// LinearLayout view = (LinearLayout) View.inflate(context,
		// R.layout.dialog_progress, null);
		if (cancelAlertDialog != null && cancelAlertDialog.isShowing()) {
			return;
		...
		TextView loadingTextView = (TextView) window.findViewById(R.id.loading_textView);
	...
	@SuppressLint("NewApi")
	public static void showDownloadCancelProgressDialog(Context context) {
		// LinearLayout view = (LinearLayout) View.inflate(context,
		// R.layout.dialog_progress, null);
		if (cancelAlertDialog != null && cancelAlertDialog.isShowing()) {
	 ...
	 *            是否处理确认键跳转主界面。
	 *//*
		 * public static void showAlertDialog(String promptMsg, final Activity
		 * activity) { builder = new AlertDialog.Builder(activity);
		 * builder.setIcon(R.drawable.icon);
		 * builder.setTitle(R.string.app_name); builder.setMessage(promptMsg);
		 * builder.setPositiveButton("确定", new OnClickListener() {
		 * 
		 * @Override public void onClick(DialogInterface dialog, int which) {
		 * Intent intent = new Intent(activity, SlidingActivity.class);
		 * intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
		 * GlobalParams.context.startActivity(intent); activity.finish();
		 * activity.overridePendingTransition(anim.slide_in_left,
		 * anim.slide_out_right); } }).setNegativeButton("取消", null);
		 * builder.show(); }
		 */
	...
	public static void showUpdateDialog(Version data, final Context context, final Activity activity) {
		...
		if (data != null) {
			...
			int versionCode = Statistics.getPackageInfo(context).versionCode;
