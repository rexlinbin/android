...
public class Statistics {
	...
	public static void init(Context contexta) {
	...
	public static String sendPost() {
		...
		params.put("app_ver", getPackageInfo(context).versionName + "");
		params.put("app_upver", String.valueOf(getPackageInfo(context).versionCode)
				+ "");
	...
	code = info.metaData.getString("InstallChannel");
		...
		Log.e("getChannelCode", e.toString());
		}
		return code;
	}
