...
public class FileUtils {
	...
	public static void createAbsoluteDirectory(String name) {
	...
	public static void saveDatas(Object obj, String path, String fileName) throws Exception {
	...
	public static Object getDatas(String path, String fileName) throws Exception {
		File rootFile = Environment.getExternalStorageDirectory();
		File pathfile = new File(rootFile, path);
		if (!pathfile.exists())
			return null;
	...
	public static long getSystemAvailableSize() {
		...
		return getAvailableSize(getPath2());
	}
	...
	public static String getPath2() {
		return getStoragePath(sContext,true);
		
		
	}
	/**
	 * 
	 * @return  is_removale =false内置sd卡路径 true 为外置SD卡路径
	 */
