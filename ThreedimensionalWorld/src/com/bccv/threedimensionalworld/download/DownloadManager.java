...
public class DownloadManager {
	...
	public DownloadInfo addNewDownload(String url, String fileName,
			String target, boolean autoResume, boolean autoRename,
			final RequestCallBack<File> callback, String app_idString,
			String app_urlString, String app_nameString, String packageString,
			float app_score_interfaceString, String app_introString)
			throws DbException {
		...
		downloadInfo.setApp_idString(app_idString);
		downloadInfo.setApp_urlString(app_urlString);
		downloadInfo.setApp_nameString(app_nameString);
		downloadInfo.setPackageString(packageString);
		downloadInfo.setApp_introString(app_introString);
		downloadInfo.setApp_score_interfaceString(app_score_interfaceString);
		...
		for (int i = 0; i < downloadInfoList.size(); i++) {
			DownloadInfo downloadInfo2 = downloadInfoList.get(i);
			if (downloadInfo2.getApp_idString().equals(app_idString)) {
