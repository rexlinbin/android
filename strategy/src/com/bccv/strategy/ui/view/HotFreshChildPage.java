...
import com.bccv.strategy.ui.adapter.HotFreshChildListAdapter;
import com.bccv.strategy.ui.adapter.HotFreshChildListAdapter.OnBtnClickListener;
...
public class HotFreshChildPage implements OnClickListener, IXListViewListener, OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
			long id) {
		Intent appDetailsIntent = new Intent(mActivity, StrategyDetailsActivity.class);
		appDetailsIntent.putExtra(BackGroundView.BACKGROUND_COLOR, mActivity.backGroundView.getGradientColor());
		appDetailsIntent.putExtra(StrategyDetailsActivity.RAID_ID, dataList.get(position-1).getId());
		appDetailsIntent.putExtra(StrategyDetailsActivity.GAME_ID, dataList.get(position-1).getGame_id());
