...
public class ClassificationActivity extends BaseActivity implements IXListViewListener, OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		//TODO 
		Intent appDetailsIntent = new Intent(this, StrategyDetailsActivity.class);
		appDetailsIntent.putExtra(BackGroundView.BACKGROUND_COLOR, this.background_view.getGradientColor());
		appDetailsIntent.putExtra(StrategyDetailsActivity.RAID_ID, appList.get(position-1).getId());
		appDetailsIntent.putExtra(StrategyDetailsActivity.GAME_ID, appList.get(position-1).getGame_id());
