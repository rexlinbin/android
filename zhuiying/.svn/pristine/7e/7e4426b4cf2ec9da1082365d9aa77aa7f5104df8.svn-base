...
public class HttpURLConnectionUtil {
	 ...
	 * @return
	 */
	public static String sendPost(Map<String, String> params, String strUrlPath) {
	 ...
	 * @return
	 */
	public static String sendPostWithAES(Map<String, String> params, String strUrlPath) {
		byte[] data = AES.encrypt(getRequestData(params).toString()).getBytes();// 获得请求体
		try {
			URL url = new URL(strUrlPath);
			HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
			httpURLConnection.setConnectTimeout(3000); // 设置连接超时时间
