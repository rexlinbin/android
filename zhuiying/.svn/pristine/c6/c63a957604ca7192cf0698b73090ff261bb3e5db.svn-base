package com.utils.pulltorefresh;
...
import com.utils.pulltorefresh.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    private void setLastUpdateTime() {
		String timeText = AppConfig.getLastUpdateTime(categoryId + "");
		if (!StringUtils.isEmpty(timeText)) {
			setLastUpdatedLabel(timeText);
			Date date = new Date();
			SimpleDateFormat formatter = new SimpleDateFormat("MM-dd HH:mm:ss",
					Locale.CHINA);
			timeText = formatter.format(date);
			AppConfig.setLastUpdateTime(timeText, categoryId + "");
		}else{
			Date date = new Date();
			SimpleDateFormat formatter = new SimpleDateFormat("MM-dd HH:mm:ss",
					Locale.CHINA);
    ...
    public final boolean onTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_DOWN:
            ...
            mIsHandledTouchEvent = false;
            GlobalParams.rawX = (int) ev.getRawX();
            GlobalParams.rawY = (int) ev.getRawY();
//            iamgeLoader.pause();
            break;
    ...
    protected void addRefreshableView(Context context, T refreshableView) {
        ...
        addView(mRefreshableViewWrapper, params);
    }
