...
import com.bccv.tianji.api.Url;
...
public class MipcaActivityCapture extends BaseActivity implements Callback {
	...
	private void login(String result){
		final String url = result + "&type=1&user_id=" + GlobalParams.user.getUser_id();
		com.utils.tools.Callback callback = new com.utils.tools.Callback() {
			...
			public void handleResult(String result) {
				...
				Toast.makeText(MipcaActivityCapture.this, "登录失败！请重新扫描", 1).show();
		...
		new DataAsyncTask(callback, false) {
			...
			protected String doInBackground(String... params) {
				...
				String statusString = util.sendGet(url, params1);
				return statusString;
			}
		}.execute("");
	}
