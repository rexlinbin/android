...
public class AppConfig {
	...
	public final static String ISDOWNLOAD = "isdownload";
	...
	public static SharedPreferences getSharedPreferences() {
		return PreferenceManager
				.getDefaultSharedPreferences(GlobalParams.context);
	}
	...
	public static int getPrefFontsize() {
		return getSharedPreferences().getInt(CONF_NEWSPAGE_FONTSIZE,
				NEWSPAGE_FONTSIZE_NORMAL);
	}
	...
	public static void setPrefFontSize(int fontSize) {
		getSharedPreferences().edit().putInt(CONF_NEWSPAGE_FONTSIZE, fontSize)
				.commit();
	}
	 ...
	 * 判断下载
	 */
	public static void isDownLoad(String text) {
		Editor editor = getSharedPreferences().edit();
		editor.putString(ISDOWNLOAD, text);
		editor.commit();
	}

	public static String getDown() {

		return getSharedPreferences().getString(ISDOWNLOAD, "");
